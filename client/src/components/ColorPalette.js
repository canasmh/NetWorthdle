...
function ColorPalette(props) {
    ...
    const Button = styled.button`
        ...
        &:hover {
            color: ${props => props.selected ? currentTheme.secondary : currentTheme.primary};
            background-color: ${props => props.selected ? currentTheme.primary : currentTheme.secondary};
            border: 1px solid ${props => props.selected ? currentTheme.secondary : currentTheme.primary};
        }
    `
